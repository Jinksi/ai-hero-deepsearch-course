...
import { z } from "zod";
import { clarificationModel } from "~/models";
...
export const handleClarificationRequest = (
  ctx: SystemContext,
  reason: string,
...
- Ask specific questions to clarify the ambiguity
- Explain briefly why you need the clarification
